...
- `third_party/hdiffpatch/` is a **trimmed** copy of a pinned tag (`VERSION` file). Do not vendor `hdiffz.cpp`, dir_diff, or zlib/zstd/lzma plugins. Compile flags keep dir/bsdiff/vcdiff/MT/compress plugins off.
